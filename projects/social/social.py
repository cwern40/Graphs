...
​
    ...
    def get_all_social_paths(self, user_id):
        ...
        # find all friends of the first node
        # add friends and path to the visited dictionary
        # find friends of friends and add to queue.
        # Add friends of friends and path to visited dictionary
        ...
        while friends_to_visit.size() > 0:
            ...
            if current_path[-1] not in visited:
                ...
                for friend in self.friendships[current_path[-1]]:
                    ...
                    friends_to_visit.enqueue(new_path)
